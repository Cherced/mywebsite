  ...
  return (
    <div className="resume" id="aboutMe">
      ...
      <p>When Covid-19 impacted the world I wanted to do a big change in my professional life, and I decide to make the switch to a professional career.
          Im currently improving my technical skills in frontend technologies... HTML, CSS, JAVASCRIPT, a fan of Vercel and its Next.js framework. 
      ...
      <a href="#" onClick={() => (router.push('/VideoAboutMe'))}><button className="button" type="text">MORE</button></a>
    </div>
  )
}
